...
namespace SharedKernel.Application.Models.Abstractions.Interfaces.ApplicationManager.Operators.Roles.Operations.CRUD.Queries.GetRoles {

    public interface IGetRoles_Query : IGetEntities_Query { }
