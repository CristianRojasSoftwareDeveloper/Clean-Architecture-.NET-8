...
namespace SharedKernel.Application.Models.Abstractions.Interfaces.ApplicationManager.Operators.SystemLogs.Operations.CRUD.Queries.GetSystemLogs {

    public interface IGetSystemLogs_Query : IGetEntities_Query { }
